...
//    public class AutocompleteTextbox : HTMLElement<HTMLInputElement>
//    {
//        #region bridgenet code
//        [Template("document.createElement('input')")]
//        public extern AutocompleteTextbox();
...
//        //    this.
//        //    _tags = new string[0];
//        //    this.Type = Html5.InputType.Text;
//        //    new jQuery2.jQuery(this).ToDynamic().autocomplete(_tags);
//        //}
